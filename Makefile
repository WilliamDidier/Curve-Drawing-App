...
# Generated by qmake (2.01a) (Qt 4.8.7) on: lun. nov. 20 13:48:55 2017
# Project:  main.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bichmoute1.0.0/ && $(COPY_FILE) --parents mainWidget.h toolsWidget.h drawingWidgetItems.h drawingWidget.h animationWidgetItems.h animationWidget.h scene.h curve1D.h curve2D.h curve1DLinear.h curve2DLinear.h curve2DBezier.h animatedPoint.h .tmp/bichmoute1.0.0/ && $(COPY_FILE) --parents main.cpp mainWidget.cpp toolsWidget.cpp drawingWidgetItems.cpp drawingWidget.cpp animationWidgetItems.cpp animationWidget.cpp scene.cpp animatedPoint.cpp .tmp/bichmoute1.0.0/ && (cd `dirname .tmp/bichmoute1.0.0` && $(TAR) bichmoute1.0.0.tar bichmoute1.0.0 && $(COMPRESS) bichmoute1.0.0.tar) && $(MOVE) `dirname .tmp/bichmoute1.0.0`/bichmoute1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bichmoute1.0.0
