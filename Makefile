#############################################################################
# Makefile for building: CurveApp
# Generated by qmake (2.01a) (Qt 4.8.7) on: mer. mars 28 14:47:41 2018
# Project:  main.pro
# Template: app
...
CXXFLAGS      = -m64 -pipe -std=c++11 -g -Wall -Wextra -Werror -Wno-unused-parameter -Wno-unused-variable -Wno-unused-but-set-variable -Wno-misleading-indentation -Wno-deprecated-declarations -O2 -Wall -W -D_REENTRANT $(DEFINES)
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/CurveApp1.0.0 || $(MKDIR) .tmp/CurveApp1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/CurveApp1.0.0/ && $(COPY_FILE) --parents mainWidget.h toolsWidget.h drawingWidgetItems.h drawingWidget.h animationWidgetItems.h animationWidget.h scene.h curve1D.h curve1DHermite.h curve1DRessortHermite.h curve1DRebondHermite.h curve2DBsplines.h curve2D.h curve1DLinear.h curve2DLinear.h curve1DLinearRessort.h curve1DLinearRebond.h curve2DLinearclosed.h curve1DBezier.h curve2DBezier.h curve2DBezierclosed.h curve_2D_lagrange.h curve1DLagrange.h curve2DBsplines.h curve2Dhermite.h curve1DHermiteChange.h curve1DHermite_random.h curve2DBezierSin.h curve2DBezierWeird.h curve2DBsplinesChordal.h animatedPoint.h .tmp/CurveApp1.0.0/ && $(COPY_FILE) --parents main.cpp mainWidget.cpp toolsWidget.cpp drawingWidgetItems.cpp drawingWidget.cpp animationWidgetItems.cpp animationWidget.cpp scene.cpp curve_2D_lagrange.cpp animatedPoint.cpp .tmp/CurveApp1.0.0/ && (cd `dirname .tmp/CurveApp1.0.0` && $(TAR) CurveApp1.0.0.tar CurveApp1.0.0 && $(COMPRESS) CurveApp1.0.0.tar) && $(MOVE) `dirname .tmp/CurveApp1.0.0`/CurveApp1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/CurveApp1.0.0
...
curve_2D_lagrange.o: curve_2D_lagrange.cpp curve_2D_lagrange.h \
		curve2D.h \
		animatedPoint.h \
		curve1D.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o curve_2D_lagrange.o curve_2D_lagrange.cpp
