#ifndef CURVE_1D_HERMITERESSORT_H
#define CURVE_1D_HERMITERESSORT_H
...
class Curve1DRessortHermite : public Curve1D {
 public:
 Curve1DRessortHermite(const QString &name) : Curve1D(name) {}
 Curve1DRessortHermite(Curve1D *curve,const QString &name) : Curve1D(curve,name) {}
...
class Curve1DRessortHermiteConstructor : public Curve1DConstructor {
 public:
  virtual ~Curve1DRessortHermiteConstructor()                    {}
  virtual const QString type() const                      { return "RessortHermiteCurve";             }
  virtual Curve1D *create(const QString &name)            { return new Curve1DRessortHermite(name);   }
  virtual Curve1D *create(Curve1D *c,const QString &name) { return new Curve1DRessortHermite(c,name); }
};



#endif // CURVE_1D_HERMITERESSORT_H
