...
static const char qt_meta_stringdata_DrawingWidget[] = {
    "DrawingWidget\0"
};
...
const QMetaObjectExtraData DrawingWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DrawingWidget::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_DrawingWidget,
      qt_meta_data_DrawingWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DrawingWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DrawingWidget))
